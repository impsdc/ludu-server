...
import { OrganizationsController } from './location.controller';
import { OrganizationsService } from './location.service';
...
const createOrganizationDto: CreateLocationDto = {
  name: 'name #1',
};

const updateOrganizationDto: UpdateLocationDto = {
  name: 'name update',
};
